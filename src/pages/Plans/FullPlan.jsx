      ...
      <header>
        ...
        >
          ...
          <div className="cover-content-plans paragraph" style={{width:'1080px'}}>
            ...
            Get unlimited access to our gym facilities, including classes and amenities. Our experienced trainers offer personalized assessments and workout plans to help you reach your goals. Enjoy member-exclusive discounts and events. Join now for a tailored fitness experience!
            </p>
            <div className="container-fluid mt-1 mt-md-5 d-flex justify-content-center align-items-center" style={{width:'310px'}}>
              <ul  className="ul-plans">
                <li>
                  <i class="bi bi-check-circle-fill me-2"></i>Unlimited gym access
                </li>
                <li>
                  <i class="bi bi-check-circle-fill me-2"></i>Customized workout plans
                </li>
                <li>
                  <i class="bi bi-check-circle-fill me-2"></i>One-on-one training sessions
                </li>
                <li>
                  <i class="bi bi-check-circle-fill me-2"></i>Nutritional guidance
                </li>
                <li>
                  <i class="bi bi-check-circle-fill me-2"></i>Discounts on additional services
                </li>
              </ul>
            </div>
          </div>
