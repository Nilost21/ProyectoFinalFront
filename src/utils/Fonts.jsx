function Fonts() {
  return (
    <div>
      ...
      <h4 className="kanit-semibold ">Hola Mundo Probando Fuente</h4>
      <h5 className="kanit-bold">Hola Mundo Probando Fuente</h5>
      <h5 className="kanit-extrabold ">Hola Mundo Probando Fuente</h5>
    </div>
  );
}
