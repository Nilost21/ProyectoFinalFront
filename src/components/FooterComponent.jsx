  ...
  return (
    <>
      <Row className="text-white mt-5 mb-4 ms-lg-5">
        ...
        <Col lg={3}>
          {' '}
          <h1 className="fs-3 paragraph fw-bold mt-1 pb-3">Social Networks</h1>
            ...
            <li>
              ...
              >
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-instagram mb-1 me-1"
                  viewBox="0 0 16 16"
                >
            ...
            <li>
              ...
              >
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-facebook mb-1 me-1"
                  viewBox="0 0 16 16"
                >
            ...
            <li>
              ...
              >
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-twitter-x mb-1 me-1"
                  viewBox="0 0 16 16"
                >
            ...
            <li>
              ...
              >
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-discord mb-1 me-1"
                  viewBox="0 0 16 16"
                >
