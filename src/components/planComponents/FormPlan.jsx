...
const FormPlan = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!nombyapRegex.test(nombre) || !nombyapRegex.test(apellido) ) {
    ...
    // Validar mensaje
    if (mensaje.length > 1500 || mensaje === "") {
      alert('El mensaje no puede tener más de 1500 caracteres o el campo no debe estar vacio');
      return;
    }
