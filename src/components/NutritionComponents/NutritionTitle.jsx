  ...
  return (
    <>
      <Row className="d-flex flex-row justify-content-center mt-5">
        <h1 className="text-center title increase-font-size-title text-white pe-0">
          Discover our nutrition posts and blog tips
        </h1>
        <div className="pe-0">
          <p className="text-center text-gray pt-3 px-md-5 mb-md-5 subtitles increase-font-paragraph  small-font">
