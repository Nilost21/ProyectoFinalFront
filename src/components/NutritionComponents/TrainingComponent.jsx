      ...
      <div className="mx-3 pe-md-5" data-aos="fade-left">
        ...
        <Row className="mb-3 border-top custom-row">
          ...
          <Col xs={9} className="d-flex align-items-center">
            <div>
              <p className="mt-4 mt-md-5 custom-title paragraph fs-5">
                Training
              </p>
              <h2 className="text-white mb-md-3 fs-3 paragraph">
        ...
        <Row className="mb-0 mb-md-3 mt-md-5 border-top custom-row">
          ...
          <Col xs={9} className="d-flex align-items-center">
            <div>
              ...
              <p className="text-white-50 mt-md-4 pe-md-5 custom-text small-font">
